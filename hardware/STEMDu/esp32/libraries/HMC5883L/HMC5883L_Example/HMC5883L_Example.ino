...
*/
/***************************************************
ファイル名: HMC5883L_Example
概要: HMC5883L三軸デジタルコンパスモジュール応用例
履歴: 2013年3月1日
...
void Output(MagnetometerRaw raw, MagnetometerScaled scaled, float heading, float headingDegrees)
{
   ...
   Serial.print(scaled.XAxis);                 // 設定されたスケールにスケールされた生データ
   Serial.print("   ");   
   Serial.print(scaled.YAxis);
   Serial.print("   ");   
   Serial.print(scaled.ZAxis);
 
   Serial.print("   \tHeading:\t");           //  向首方向のラジアンと度数データ
